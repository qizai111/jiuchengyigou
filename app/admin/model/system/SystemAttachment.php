...
class SystemAttachment extends BaseModel
{
     ...
     */
    public static function attachmentAdd($name,$att_size,$att_type,$att_dir,$satt_dir='',$pid = 0,$imageType = 1 ,$time = 0 , $module_type=1 , $uid = '')
    {
        $data['name'] = $name;
    ...
    public static function getBase($id){
        $where['pid'] = $id;
        $where['module_type'] = 1;
        return  SystemAttachment::where($where)->order("att_id desc")->select()->toArray();;
    }
