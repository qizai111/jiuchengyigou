...
<head>
    ...
    <title>登录管理系统 -  Powered by 酒城易购!</title>
    <meta name="generator" content="酒城易购" />
    <meta name="author" content="酒城易购! Team and 酒城易购 UI Team" />
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div class="login-group">
        <h3 class="login-logo" style="width: 150px;height: 80px;margin-top: 10%;margin-left: 25%">
            <!--<img src="{__ADMIN_PATH}images/logo.png">-->
            <text style="font-size: 26px;">酒 城 易 购</text>
        </h3>
...
<div class="footer" style=" position: fixed;bottom: 0;width: 100%;left: 0;margin: 0;opacity: 0.8;">
    <div class="pull-right">© 2017-2019 <a href="http://www.crmeb.com/" target="_blank">酒城易购</a>
    </div>
</div>
