...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="admin_close" target="_blank" href="http://www.lzzhongyiyuan.com/">联系我们</a>
                            </li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2019-2020 <a href="http://www.lzzhongyiyuan.com/" target="_blank">酒城易购</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
