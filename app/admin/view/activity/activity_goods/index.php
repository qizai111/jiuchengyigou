    ...
    <div class="layui-row layui-col-space15"  id="app">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">活动商品搜索</div>
                <div class="layui-card-body">
                    <div class="alert alert-success alert-dismissable">
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                        目前拥有{$countGoods}个活动商品
                    </div>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">活动商品列表</div>
                <div class="layui-card-body">
                    <table class="layui-hide" id="goodslList" lay-filter="goodslList"></table>
...
<script>
    layList.form.render();
    layList.tableList('goodslList',"{:Url('get_goods_list')}",function () {
        return [
            {field: 'id', title: 'ID', sort: true,width:'6%',event:'id'},
            {field: 'image', title: '产品图片', width: '14%',templet: '<p><img src="{{d.image}}" alt="{{d.simple_name}}" class="open_image" data-image="{{d.image}}"></p>'},
            {field: 'simple_name', title: '产品简称',width:'10%'},
            {field: 'price', title: '原价',width:'8%'},
            {field: 'unit', title: '单位', width: '10%'},
            {field: 'status', title: '活动商品状态',width:'12%',toolbar:"#status"},
