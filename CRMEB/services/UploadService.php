...
class UploadService
{
     ...
     * @return mixed
     */
    public function image($fileName,$directory)
    {
        $info = [];
        try {
            ...
            switch ($uploadType) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    $serverImageInfo = OSS::uploadImage($fileName,$directory);
     ...
     * @throws \Exception
     */
    public function imageStream($key, $content, $root = '',$path = '')
    {
        ...
        switch ($uploadType) {
            ...
            case 3 :
                ...
                $serverImageInfo = OSS::uploadImageStream($key, $content,$path);
                if (!is_array($serverImageInfo)) return $serverImageInfo;
                $info = $this->setUploadInfo(UtilService::setHttpType($serverImageInfo['info']['url']), 3, substr(strrchr($serverImageInfo['info']['url'], '/'), 1));
                break;
            case 4 :
